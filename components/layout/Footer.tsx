    ...
    <footer className="bg-secondary border-t border-border mt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          {/* Help */}
          <div>
            <h3 className="text-sm font-semibold text-foreground mb-4">Help</h3>
            <ul className="space-y-2">
              <li>
              ...
              <li>
                <Link href="/refund" className="text-sm text-muted hover:text-primary transition-colors">
                  Refund Policy
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/coming-soon" className="text-sm text-muted hover:text-primary transition-colors">
                  Coming Soon
                </Link>
              </li>
              <li>
                <Link href="/offers" className="text-sm text-muted hover:text-primary transition-colors">
                  Offers
                </Link>
              </li>
              <li>
                <Link href="/snacks" className="text-sm text-muted hover:text-primary transition-colors">
                  Food & Beverages
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="flex gap-2 sm:gap-3 md:gap-4 mb-4 flex-wrap">
              <a
                ...
                className="w-10 h-10 bg-card rounded-full flex items-center justify-center hover:bg-primary hover:text-white transition-colors"
              >
        ...
        <div className="mt-12 pt-8 border-t border-border">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-bold">Shindhu Cinemas</span>
            </div>
            <p className="text-sm text-muted text-center">
              © {new Date().getFullYear()} Shindhu Cinemas. All rights reserved.
            </p>
